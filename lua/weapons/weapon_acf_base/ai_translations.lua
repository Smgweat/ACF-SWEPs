...
function SWEP:SetupWeaponHoldTypeForAI( t )
    ...
    if ( t == "smg" ) then
        ...
        self.ActivityTranslateAI[ ACT_IDLE ]          = ACT_IDLE_SMG1
        self.ActivityTranslateAI[ ACT_IDLE_ANGRY ]    = ACT_IDLE_ANGRY_SMG1
        self.ActivityTranslateAI[ ACT_WALK ]          = ACT_WALK_SMG1

        self.ActivityTranslateAI[ ACT_IDLE_RELAXED ]    = ACT_IDLE_SMG1_RELAXED
        self.ActivityTranslateAI[ ACT_IDLE_STIMULATED ] = ACT_IDLE_SMG1_STIMULATED
        self.ActivityTranslateAI[ ACT_IDLE_AGITATED ]   = ACT_IDLE_ANGRY_SMG1

        self.ActivityTranslateAI[ ACT_WALK_RELAXED ]    = ACT_WALK_SMG1_RELAXED
        self.ActivityTranslateAI[ ACT_WALK_STIMULATED ] = ACT_WALK_SMG1_STIMULATED
        self.ActivityTranslateAI[ ACT_WALK_AGITATED ]   = ACT_WALK_AIM_SMG1

        self.ActivityTranslateAI[ ACT_RUN_RELAXED ]    = ACT_RUN_SMG1_RELAXED
        self.ActivityTranslateAI[ ACT_RUN_STIMULATED ] = ACT_RUN_SMG1_STIMULATED
        self.ActivityTranslateAI[ ACT_RUN_AGITATED ]   = ACT_RUN_AIM_SMG1

        self.ActivityTranslateAI[ ACT_IDLE_AIM_RELAXED ]    = ACT_IDLE_SMG1_RELAXED
        self.ActivityTranslateAI[ ACT_IDLE_AIM_STIMULATED ] = ACT_IDLE_AIM_SMG1_STIMULATED
        self.ActivityTranslateAI[ ACT_IDLE_AIM_AGITATED ]   = ACT_IDLE_ANGRY_SMG1

        self.ActivityTranslateAI[ ACT_WALK_AIM_RELAXED ]    = ACT_WALK_SMG1_RELAXED
        self.ActivityTranslateAI[ ACT_WALK_AIM_STIMULATED ] = ACT_WALK_AIM_SMG1_STIMULATED
        self.ActivityTranslateAI[ ACT_WALK_AIM_AGITATED ]   = ACT_WALK_AIM_SMG1

        self.ActivityTranslateAI[ ACT_RUN_AIM_RELAXED ]    = ACT_RUN_SMG1_RELAXED
        self.ActivityTranslateAI[ ACT_RUN_AIM_STIMULATED ] = ACT_RUN_AIM_SMG1_STIMULATED
        self.ActivityTranslateAI[ ACT_RUN_AIM_AGITATED ]   = ACT_RUN_AIM_SMG1

        self.ActivityTranslateAI[ ACT_WALK_AIM ]              = ACT_WALK_AIM_SMG1
        self.ActivityTranslateAI[ ACT_WALK_CROUCH ]           = ACT_WALK_CROUCH_SMG1
        self.ActivityTranslateAI[ ACT_WALK_CROUCH_AIM ]       = ACT_WALK_CROUCH_AIM_SMG1
        self.ActivityTranslateAI[ ACT_RUN ]                   = ACT_RUN_SMG1
        self.ActivityTranslateAI[ ACT_RUN_AIM ]               = ACT_RUN_AIM_SMG1
        self.ActivityTranslateAI[ ACT_RUN_CROUCH ]            = ACT_RUN_CROUCH_SMG1
        self.ActivityTranslateAI[ ACT_RUN_CROUCH_AIM ]        = ACT_RUN_CROUCH_AIM_SMG1
