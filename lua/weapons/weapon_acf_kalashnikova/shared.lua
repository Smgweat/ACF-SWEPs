...
if (CLIENT) then
	...
	SWEP.PrintName		= "Avtomat Kalashnikova"
	SWEP.Purpose		= "Reliable Soviet-Era Rifle"
	SWEP.Instructions	= ""
end
...
SWEP.Primary.Sound			= "weapons/acf_swep/weapon_acf_kalashnikova.wav"
...
SWEP.IronSightsPos 	= Vector(-10, 6.55, 1.7)
SWEP.ZoomPos 		= Vector(2,-2,2)
SWEP.IronSightsAng 	= Angle(-3, 0.1, 0)
